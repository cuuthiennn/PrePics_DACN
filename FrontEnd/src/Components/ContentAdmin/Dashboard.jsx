...
import MyLineChartAdmin from '../Chart/LineChartAdmin';
import MyPieChart from '../Chart/PieChart';
import Sidebar from '../Administrator/Sidebar';
import Topbar from '../Administrator/Topbar';

const Dashboard = () => {
    return ( 
            <div className="container-fluid">
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 className="h3 mb-0 text-gray-800">Bảng điều khiển</h1>
                    ...
                    <div className="card-body">
                        <div className="row no-gutters align-items-center">
                            <div className="col mr-2">
                                ...
                                <div className="flex no-gutters align-items-center">
                                    <div className="col-auto">
    ...
    <div className="col-xl-8 col-lg-7">
        <div className="card shadow mb-4">
            ...
            <div className="card-body">
                ...
                <MyLineChartAdmin></MyLineChartAdmin>
                </div>
            </div>
        </div>
    </div>
        ...
        <div className="card shadow mb-4">
            ...
            <div className="card-body">
                ...
                <div className="mt-4 text-center small">
                    ...
                    <span className="mr-2">
                        <i className="fas fa-circle text-purple-500"></i> Referral
                    </span>
                </div>
            </div>
        </div>
    ...
    <div className="card shadow mb-4">
      ...
      <div className="card-body">
        <div className="text-center">
          <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{ width: "25rem" }} src="/src/assets/images/undraw_posting_photo.svg" alt="..." />
        </div>
